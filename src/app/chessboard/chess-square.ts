...
export class ChessSquare {
    ...
    set piece(value: Piece) {
        ...
        for (let sp of sd.paths) {
            let svp = new SvgPath(this.addXY(sp.d), sp.className);
    ...
    get blackKnight(): SvgData {
        ...
        ret.paths.push(new SvgPath("M 9.5,25.5 A 0.5,0.5 0 1 1 8.5,25.5 A 0.5,0.5 0 1 1 9.5,25.5 z",
            "black-piece  white-line"));
        // eye:
        let eye = new SvgPath("M 13.5,15 A 0.5,0.9 0 1 1 13,16 A 0.5,1.5 0 1 1 14,16 z",
            "white-line");
        ret.paths.push(eye);
        // mane:
